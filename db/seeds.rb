...
Request.create!(title:"Cat Sitting", user_id:3, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0KldwRAXOUzmWu4V_aW0ApP8qGIt0hyHjGg&usqp=CAU", start_date:'2022-08-10T9:00',end_date: '2022-08-217T16:00', description: "Our cats need their litter box cleaned on the 15th, and they will need a can of food a fresh water everyone morning and evening.",  accepted: "")
...
User.create!(username: "Cindy1", password: "rosebud", email:"Chone@fmail.com", bio: "Hi, I live down the block. I currently have a fish tank of pet fish, but I also grew up with dogs, and other animals. I would love to help out anytime.", request:"")
