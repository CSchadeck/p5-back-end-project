...
User.create!(username: "Cindy1", password: "rosebud", email:"Chone@fmail.com", bio: "Hi, I live down the block. I currently have a fish tank of pet fish, but I also grew up with dogs, and other animals. I would love to help out anytime.")
